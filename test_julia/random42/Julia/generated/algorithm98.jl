...
function algorithm98(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2})
    ...
    # M233: ml2, full, M235: ml3, full, M234: ml4, full, M236: ml5, full, tmp1: ml0, full
    # tmp7 = (M234 + M236)
    # cost_K 4.8e+06 oprs_K 1.0 ml5 ml4
    axpy!(1.0, ml5, ml4) # matrices

    # M233: ml2, full, M235: ml3, full, tmp1: ml0, full, tmp7: ml4, full
    # tmp3 = (M235 + tmp7^T)
