...
function algorithm68(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2})
    ...
    # M233: ml2, full, M236: ml5, full, tmp1: ml0, full, tmp31: ml3, full
    # tmp3 = (tmp31 + M236^T)
