...
function algorithm92(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2})
    ...
    # tmp7 = (M234 + M236)
    # cost_K 4.8e+06 oprs_K 1.0 ml5 ml4
    axpy!(1.0, ml5, ml4) # matrices

    # M231: ml0, full, M232: ml1, full, M233: ml2, full, M235: ml3, full, tmp7: ml4, full
    # tmp3 = (M235 + tmp7^T)
    # cost_K 2.4e+06 oprs_K ml3 ml4
    ml3 .+= transpose(ml4)

    # M231: ml0, full, M232: ml1, full, M233: ml2, full, tmp3: ml3, full
    ...
    # M231: ml0, full, M232: ml1, full, tmp5: ml6, full
    # tmp1 = (M231 + M232^T)
    # cost_K 1.95e+06 oprs_K ml0 ml1
    ml0 .+= transpose(ml1)

    # tmp5: ml6, full, tmp1: ml0, full
