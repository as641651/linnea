...
function main()
    ...
    Benchmarker.add_data(plotter, ["algorithm93"; 24], Benchmarker.measure(3, algorithm93, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm94"; 24], Benchmarker.measure(3, algorithm94, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm95"; 24], Benchmarker.measure(3, algorithm95, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm96"; 24], Benchmarker.measure(3, algorithm96, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm97"; 24], Benchmarker.measure(3, algorithm97, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm98"; 24], Benchmarker.measure(3, algorithm98, map(MatrixGenerator.unwrap, matrices)...) );
    Benchmarker.add_data(plotter, ["algorithm99"; 24], Benchmarker.measure(3, algorithm99, map(MatrixGenerator.unwrap, matrices)...) );
