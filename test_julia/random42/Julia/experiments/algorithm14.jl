...
function algorithm14(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2})
    start::Float64 = 0.0
    finish::Float64 = 0.0
    ...
    # M231: ml0, full, M232: ml1, full, M233: ml2, full, M234: ml4, full, tmp2: ml3, full
    # tmp3 = (tmp2 + M234^T)
