...
function algorithm97(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2}, ml6::Array{Float64,2})
    # sizeArg ml0:(400, 400)
    # sizeArg ml1:(400, 400)
    # sizeArg ml2:(400, 400)
    # sizeArg ml3:(150, 400)
    ...
    # M237: ml0, full, M241: ml4, full, M242: ml5, full, M243: ml6, full, tmp8: ml7, full
    # tmp12 = (tmp8 M237^T)
    # cost_K 2.4e+07 oprs_K 1.0 ml0 ml7
    trmm!('R', 'L', 'T', 'N', 1.0, ml0, ml7)

    # M241: ml4, full, M242: ml5, full, M243: ml6, full, tmp12: ml7, full
    # tmp5 = (M241^-1 M242)
    # cost_K 1.12e+06 oprs_K 1.0 ml4 ml5
    trsm!('L', 'U', 'N', 'N', 1.0, ml4, ml5)

    # M243: ml6, full, tmp12: ml7, full, tmp5: ml5, full
