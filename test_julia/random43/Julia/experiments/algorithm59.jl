...
function algorithm59(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2}, ml6::Array{Float64,2})
    ...
    # M237: ml0, full, M240: ml3, full, M241: ml4, full, M242: ml5, full, M243: ml6, full, tmp2: ml2, full
    # tmp5 = (M241^-1 M242)
    # cost_K 1.12e+06 oprs_K 1.0 ml4 ml5
    trsm!('L', 'U', 'N', 'N', 1.0, ml4, ml5)

    # M237: ml0, full, M240: ml3, full, M243: ml6, full, tmp2: ml2, full, tmp5: ml5, full
