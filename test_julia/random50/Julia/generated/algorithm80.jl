...
function algorithm80(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
    ...
    # M278: ml0, full, M279: ml1, full, tmp10: ml6, full, tmp12: ml7, full
    # tmp6 = (tmp12 + (M279^T tmp10))
    # cost_K 2.16e+08 oprs_K 1.0 1.0 ml1 ml6 ml7
    gemm!('T', 'N', 1.0, ml1, ml6, 1.0, ml7)
