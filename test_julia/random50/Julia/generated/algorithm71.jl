...
function algorithm71(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
    ...
    # M278: ml0, full, M279: ml1, full, M280: ml2, full, M281: ml3, full, tmp13: ml6, full

    # sizeArg ml7:(300, 200)
    ml7 = Array{Float64}(undef, 300, 200)
    # tmp8 = (M280^T M281)
    # cost_K 2.34e+08 oprs_K 1.0 0.0 ml2 ml3 ml7
    gemm!('T', 'N', 1.0, ml2, ml3, 0.0, ml7)

    # M278: ml0, full, M279: ml1, full, tmp13: ml6, full, tmp8: ml7, full
