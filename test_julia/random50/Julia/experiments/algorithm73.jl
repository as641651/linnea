...
function algorithm73(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
    start::Float64 = 0.0
    finish::Float64 = 0.0
    ...
    # M278: ml0, full, M279: ml1, full, M280: ml2, full, M282: ml4, full, tmp12: ml6, full

    # sizeArg ml7:(300, 200)
    ml7 = Array{Float64}(undef, 300, 200)
    # tmp10 = (M280^T M282^T)
    # cost_K 2.34e+08 oprs_K 1.0 0.0 ml2 ml4 ml7
    gemm!('T', 'T', 1.0, ml2, ml4, 0.0, ml7)

    # M278: ml0, full, M279: ml1, full, tmp12: ml6, full, tmp10: ml7, full
    # tmp6 = (tmp12 + (M279^T tmp10))
    # cost_K 2.16e+08 oprs_K 1.0 1.0 ml1 ml7 ml6
    gemm!('T', 'N', 1.0, ml1, ml7, 1.0, ml6)
    ...
    # tmp7 = (M278 tmp6)
    # cost_K 1.3e+09 oprs_K 1.0 0.0 ml0 ml6 ml8
    symm!('L', 'L', 1.0, ml0, ml6, 0.0, ml8)
