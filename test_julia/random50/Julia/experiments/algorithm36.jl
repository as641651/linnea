...
function algorithm36(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
    start::Float64 = 0.0
    finish::Float64 = 0.0
    ...
    # tmp4 = (tmp10 + tmp8)
    # cost_K 1.2e+05 oprs_K 1.0 ml5 ml6
    axpy!(1.0, ml5, ml6) # matrices

    # M278: ml0, full, M279: ml1, full, tmp4: ml6, full
