...
function algorithm79(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,1})
    start::Float64 = 0.0
    finish::Float64 = 0.0
    ...
    # M109: ml0, full, M110: ml7, diagonal_vector, tmp9: ml6, full, tmp18: ml5, full
    # tmp16 = (M110 tmp9)
    # cost_K 1.15e+03 oprs_K ml7 ml6
    ml6 .*= ml7

    # M109: ml0, full, tmp18: ml5, full, tmp16: ml6, full
    # tmp6 = (tmp16 + tmp18)
