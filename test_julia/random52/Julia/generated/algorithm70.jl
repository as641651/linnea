...
function algorithm70(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2}, ml6::Array{Float64,2})
    # sizeArg ml0:(100, 100)
    ...
    # M292: ml2, full, M293: ml3, full, M290: ml4, full, tmp5: ml1, full
    # tmp15 = (tmp5 + M290^T)
