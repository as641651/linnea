...
function algorithm99(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2}, ml6::Array{Float64,2})
    # sizeArg ml0:(100, 100)
    ...
    # tmp16 = (M291 + M294)
    # cost_K 3e+05 oprs_K 1.0 ml5 ml6
    axpy!(1.0, ml5, ml6) # matrices

    # M290: ml4, full, tmp7: ml1, full, tmp16: ml6, full
    # tmp17 = (tmp7 + tmp16^T)
