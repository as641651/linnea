...
function algorithm98(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2}, ml6::Array{Float64,2})
    start::Float64 = 0.0
    finish::Float64 = 0.0
    ...
    # tmp10 = (M290 + M291)
    # cost_K 3e+05 oprs_K 1.0 ml4 ml5
    axpy!(1.0, ml4, ml5) # matrices

    # M294: ml6, full, tmp7: ml1, full, tmp10: ml5, full
    # tmp11 = (tmp7 + tmp10^T)
