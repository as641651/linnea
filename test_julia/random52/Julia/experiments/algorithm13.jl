...
function algorithm13(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2}, ml6::Array{Float64,2})
    start::Float64 = 0.0
    finish::Float64 = 0.0
    ...
    # M292: ml2, full, M293: ml3, full, M290: ml4, full, M291: ml5, full, tmp4: ml1, full
    # tmp27 = (tmp4 + M290^T)
