...
function algorithm84(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2}, ml5::Array{Float64,2}, ml6::Array{Float64,2})
    start::Float64 = 0.0
    finish::Float64 = 0.0
    ...
    # M292: ml2, full, M293: ml3, full, M291: ml5, full, M294: ml6, full, tmp20: ml1, full
    # tmp27 = (tmp20 + M294^T)
    # cost_K 1.5e+05 oprs_K ml1 ml6
    ml1 .+= transpose(ml6)

    # M292: ml2, full, M293: ml3, full, M291: ml5, full, tmp27: ml1, full
    # tmp15 = (tmp27 + M291^T)
    # cost_K 1.5e+05 oprs_K ml1 ml5
    ml1 .+= transpose(ml5)

    # M292: ml2, full, M293: ml3, full, tmp15: ml1, full
    # tmp6 = (tmp15 + (M292^T M293))
