...
function algorithm47(ml0::Float64, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,1}, ml4::Array{Float64,1}, ml5::Array{Float64,2}, ml6::Array{Float64,2})
    start::Float64 = 0.0
    finish::Float64 = 0.0
    ...
    # s144: ml0, full, M141: ml1, full, M147: ml6, full, tmp4: ml7, full, tmp6: ml8, full
    # tmp9 = (M141^-1 tmp4)
    # cost_K 2.89e+06 oprs_K ml1 ml7
    trsv!('L', 'N', 'N', ml1, ml7)

    # s144: ml0, full, M147: ml6, full, tmp6: ml8, full, tmp9: ml7, full
    ...
    # s144: ml0, full, tmp9: ml7, full, tmp12: ml9, full
    # tmp13 = (s144 tmp9)
    # cost_K 1.7e+03 oprs_K ml0 ml7
    scal!(1700, ml0, ml7, 1)

    # tmp12: ml9, full, tmp13: ml7, full
