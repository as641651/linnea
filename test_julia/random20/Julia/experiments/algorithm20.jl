...
function algorithm20(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,2}, ml3::Array{Float64,2}, ml4::Array{Float64,2})
    start::Float64 = 0.0
    finish::Float64 = 0.0
    ...
    # M107: ml2, full, tmp8: ml1, full, tmp10: ml5, full
    # (L1 L1^T) = M107
    # cost_K 1.37e+09 oprs_K ml2
    LinearAlgebra.LAPACK.potrf!('L', ml2)

    # tmp8: ml1, full, tmp10: ml5, full, L1: ml2, lower_triangular
    # tmp12 = (L1^-1 tmp10)
    # cost_K 1.02e+09 oprs_K 1.0 ml2 ml5
    trsm!('L', 'L', 'N', 'N', 1.0, ml2, ml5)

    # tmp8: ml1, full, L1: ml2, lower_triangular, tmp12: ml5, full
    # tmp6 = (L1^-T tmp12)
    # cost_K 1.02e+09 oprs_K 1.0 ml2 ml5
    trsm!('L', 'L', 'T', 'N', 1.0, ml2, ml5)

    # tmp8: ml1, full, tmp6: ml5, full
    # tmp9 = (tmp6 + tmp8^T)
    # cost_K 6.4e+05 oprs_K ml5 ml1
    ml5 .+= transpose(ml1)
